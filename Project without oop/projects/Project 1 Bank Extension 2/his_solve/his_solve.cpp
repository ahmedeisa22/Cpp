...
int ReadSetPermission() {
	...
	cin >> choice;
	if (tolower(choice) == 'y')
		sum+= (int)enMainMenuePermissions::pListClients;

	cout << "add new users (y/n): ";
	cin >> choice;
	if (tolower(choice) == 'y')
		sum += (int)enMainMenuePermissions::pAddNewClient;

	cout << "Update users (y/n): ";
	cin >> choice;
	if (tolower(choice) == 'y')
		sum += (int)enMainMenuePermissions::pUpdateClients;

	cout << "Delete users (y/n): ";
	cin >> choice;
	if (tolower(choice) == 'y')
		sum += (int)enMainMenuePermissions::pDeleteClient;

	cout << "Find users (y/n): ";
	cin >> choice;
	if (tolower(choice) == 'y')
		sum += (int)enMainMenuePermissions::pFindClient;
	cout << "transaction users (y/n): ";
	cin >> choice;
	if (tolower(choice) == 'y')
		sum += (int)enMainMenuePermissions::pTranactions;

	cout << "Manage users (y/n): ";
	cin >> choice;
	if (tolower(choice) == 'y')
		sum += (int)enMainMenuePermissions::pManageUsers;
...
bool CheckAccessPermission(enMainMenuePermissions Permission) {
	if (enMainMenuePermissions::eAll == CurrentLoginUser.permission)
		return true;
	if ((Permission & CurrentLoginUser.permission) == Permission)
		return true;
	return false;
}
void GoBackToMainMenue() {
...
bool LoadUserInfo(string UserName, string Password) {
	if (findUserByUserNameAndPassword(UserName, Password, CurrentLoginUser))
		return true;
	return false;
}
void Login() {
