...
#include "Global.h"
#include "clsShowCurrencyExchangeMainScreen.h"
...
private:
    ...
    static void _ShowTransactionsMenue()
    {
        ...
        clsTransactionScreen::ShowTransationMenu();
    }
    static void _ShowManageUsersMenue()
    {
        //cout << "\nUsers Menue Will be here...\n";
        clsManageUsersMenu::ShowMangeUserMenu();
    }
    //static void _ShowEndScreen()
    //{
    //    //cout << "\nEnd Screen Will be here...\n";
    //    _DrawScreenHeader("\tEnd User Screen");
    //}
    ...
    static void _ShowCurrencyExchange() {
        ...
        clsShowCurrencyExchangeMainScreen::ShowCurrencyExchangeScreen();
    }
    static void _Logut() {
